...
<body>
    <section id="home">
        <div class="contenido">
            ...
            <div class="presentacion">
                ...
                <h2>Soy <span>Jorge Estiven Mendez</span> Ingeniero de software</h2>
    ...
    <section id="about">
        ...
        <div class="info_sobreMi">
            ...
            <h2>Soy, <span>Jorge Mendez E</span></h2>
            <h3>Slogan</h3>
    ...
    <section id="contactus">
        ...
        <form action="">
            <div class="inputBox">
                ...
                <div class="input">
                    ...
                    <input type="number" placeholder="(+57) 3208065467">
                </div>
            </div>
            <div class="inputBox">
                <div class="input">
                    <span>ASUNTO DEL MENSAJE</span>
                    <input type="text" placeholder="Solicitud, Queja y Reclamos">
                </div>
            </div>
            <div class="inputBox">
                <div class="input">
        ...
        <div class="contact-container">
            ...
            <div class="contact-card">
                ...
                <span class="contact-card-data">dijey@gmail.com</span>
            </div>

            <div class="contact-card">
                <i class='bx bxl-whatsapp contact-card-icon'></i>
                <h3 class="contact-card-title">Whatsapp</h3>
                <span class="contact-card-data">(+57) 3208065467</span>
            </div>
